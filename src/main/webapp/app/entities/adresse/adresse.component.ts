...
export class AdresseComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.adresseService
      ...
      .subscribe(
        (res: HttpResponse<IAdresse[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IAdresse[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
