...
export class LogementComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.logementService
      ...
      .subscribe(
        (res: HttpResponse<ILogement[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInLogements(): void {
    this.eventSubscriber = this.eventManager.subscribe('logementListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ILogement[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
