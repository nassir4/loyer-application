...
describe('Logement e2e test', () => {
  ...
  it('should create and save Logements', async () => {
    ...
    await promise.all([
      logementUpdatePage.typeDePieceSelectLastOption(),
      ...
      logementUpdatePage.setCreatedAtInput('2000-12-31'),
    ...
    expect(await logementUpdatePage.getCreatedAtInput()).to.eq('2000-12-31', 'Expected createdAt value to be equals to 2000-12-31');
